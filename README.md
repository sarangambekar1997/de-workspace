...
| [`docs/02-processing`](docs/02-processing) | Data ingestion & CDC, PySpark, Databricks, dbt |
...
| [`docs/08-architecture`](docs/08-architecture) | Data engineering system design |
